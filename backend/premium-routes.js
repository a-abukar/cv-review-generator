...
router.post('/interview-prep', upload.single('file'), async (req, res) => {
  ...
  try {
    ...
    const prompt = `Based on this CV, create an extremely detailed, personalised interview preparation guide, based on DevOps technologies WITH ANSWERS. Focus on:
